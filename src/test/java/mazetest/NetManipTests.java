...
public class NetManipTests {
	public static void main(String [] args){
		NeuralNetworkImpl mlp = NNFactory.mlpSigmoid(new int[] { 5,2, 1,3,4 }, true);
...
//      [-6.1552725] - bias l3
	...
	NeuralNetworkImpl nn2 = nntools.NetworkManipulator.CopySigmoidNN(mlp);
